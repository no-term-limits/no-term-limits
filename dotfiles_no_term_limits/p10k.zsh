# Generated by Powerlevel10k configuration wizard on 2021-03-02 at 12:01 EST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 56410.
# Wizard options: ascii, classic, dark, 1 line, compact, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    prompt_char           # prompt symbol to tell you which vi mode you are in (also turns red when command fails to mitigate need for status)
  )
